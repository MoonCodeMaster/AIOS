...
// issue list. The parser is lenient: missing dimensions default to 0, a
// malformed total is recomputed from dimensions, and unknown lines are
// ignored. Empty input returns all-zero score and ErrEmptyCritique.
...
func parseKV(line string) (string, int, bool) {
